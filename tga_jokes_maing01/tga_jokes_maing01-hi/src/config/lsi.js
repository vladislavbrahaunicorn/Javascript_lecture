const Lsi = {
  appName: {
    cs: "Aplikace tgaJokes",
    en: "Application tgaJokes",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci tgaJokes",
      en: "About application tgaJokes",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní tgaJokes.",
      en: "You can buy your own tgaJokes.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci tgaJokes.",
      en: "You don't have rights to initialize this tgaJokes.",
    },
  },
